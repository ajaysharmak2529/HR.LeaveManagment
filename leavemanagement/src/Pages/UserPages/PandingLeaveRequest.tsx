...
import { useGetAllPandingLeaveRequestsQuery } from "../../Services/LeaveRequest.Service";
import Badge from "../../Components/Badge";
import Pagination from "../../Components/Pagination";
import { useState } from "react";

const PandingLeaveRequest = () => {

    const [page, setPage] = useState({ page: 1, pageSize: 10 });
    const { isLoading, isError, error, data } = useGetAllPandingLeaveRequestsQuery(page);
...
export default PandingLeaveRequest;